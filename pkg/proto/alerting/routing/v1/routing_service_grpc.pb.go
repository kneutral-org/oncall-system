...
const (
	EquipmentTypeService_CreateEquipmentType_FullMethodName    = "/alerting.routing.v1.EquipmentTypeService/CreateEquipmentType"
	EquipmentTypeService_GetEquipmentType_FullMethodName       = "/alerting.routing.v1.EquipmentTypeService/GetEquipmentType"
	EquipmentTypeService_GetEquipmentTypeByName_FullMethodName = "/alerting.routing.v1.EquipmentTypeService/GetEquipmentTypeByName"
	EquipmentTypeService_ListEquipmentTypes_FullMethodName     = "/alerting.routing.v1.EquipmentTypeService/ListEquipmentTypes"
	EquipmentTypeService_UpdateEquipmentType_FullMethodName    = "/alerting.routing.v1.EquipmentTypeService/UpdateEquipmentType"
	EquipmentTypeService_DeleteEquipmentType_FullMethodName    = "/alerting.routing.v1.EquipmentTypeService/DeleteEquipmentType"
	EquipmentTypeService_ResolveEquipmentType_FullMethodName   = "/alerting.routing.v1.EquipmentTypeService/ResolveEquipmentType"
)

// EquipmentTypeServiceClient is the client API for EquipmentTypeService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type EquipmentTypeServiceClient interface {
	// CRUD operations
	CreateEquipmentType(ctx context.Context, in *CreateEquipmentTypeRequest, opts ...grpc.CallOption) (*EquipmentType, error)
	GetEquipmentType(ctx context.Context, in *GetEquipmentTypeRequest, opts ...grpc.CallOption) (*EquipmentType, error)
	GetEquipmentTypeByName(ctx context.Context, in *GetEquipmentTypeByNameRequest, opts ...grpc.CallOption) (*EquipmentType, error)
	ListEquipmentTypes(ctx context.Context, in *ListEquipmentTypesRequest, opts ...grpc.CallOption) (*ListEquipmentTypesResponse, error)
	...
	// Resolve equipment type from alert labels
	ResolveEquipmentType(ctx context.Context, in *ResolveEquipmentTypeRequest, opts ...grpc.CallOption) (*ResolveEquipmentTypeResponse, error)
}

type equipmentTypeServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewEquipmentTypeServiceClient(cc grpc.ClientConnInterface) EquipmentTypeServiceClient {
	return &equipmentTypeServiceClient{cc}
}

func (c *equipmentTypeServiceClient) CreateEquipmentType(ctx context.Context, in *CreateEquipmentTypeRequest, opts ...grpc.CallOption) (*EquipmentType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EquipmentType)
	err := c.cc.Invoke(ctx, EquipmentTypeService_CreateEquipmentType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) GetEquipmentType(ctx context.Context, in *GetEquipmentTypeRequest, opts ...grpc.CallOption) (*EquipmentType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EquipmentType)
	err := c.cc.Invoke(ctx, EquipmentTypeService_GetEquipmentType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) GetEquipmentTypeByName(ctx context.Context, in *GetEquipmentTypeByNameRequest, opts ...grpc.CallOption) (*EquipmentType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EquipmentType)
	err := c.cc.Invoke(ctx, EquipmentTypeService_GetEquipmentTypeByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) ListEquipmentTypes(ctx context.Context, in *ListEquipmentTypesRequest, opts ...grpc.CallOption) (*ListEquipmentTypesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEquipmentTypesResponse)
	err := c.cc.Invoke(ctx, EquipmentTypeService_ListEquipmentTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) UpdateEquipmentType(ctx context.Context, in *UpdateEquipmentTypeRequest, opts ...grpc.CallOption) (*EquipmentType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EquipmentType)
	err := c.cc.Invoke(ctx, EquipmentTypeService_UpdateEquipmentType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) DeleteEquipmentType(ctx context.Context, in *DeleteEquipmentTypeRequest, opts ...grpc.CallOption) (*DeleteEquipmentTypeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteEquipmentTypeResponse)
	err := c.cc.Invoke(ctx, EquipmentTypeService_DeleteEquipmentType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentTypeServiceClient) ResolveEquipmentType(ctx context.Context, in *ResolveEquipmentTypeRequest, opts ...grpc.CallOption) (*ResolveEquipmentTypeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveEquipmentTypeResponse)
	err := c.cc.Invoke(ctx, EquipmentTypeService_ResolveEquipmentType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// EquipmentTypeServiceServer is the server API for EquipmentTypeService service.
// All implementations must embed UnimplementedEquipmentTypeServiceServer
// for forward compatibility.
type EquipmentTypeServiceServer interface {
	// CRUD operations
	CreateEquipmentType(context.Context, *CreateEquipmentTypeRequest) (*EquipmentType, error)
	GetEquipmentType(context.Context, *GetEquipmentTypeRequest) (*EquipmentType, error)
	GetEquipmentTypeByName(context.Context, *GetEquipmentTypeByNameRequest) (*EquipmentType, error)
	ListEquipmentTypes(context.Context, *ListEquipmentTypesRequest) (*ListEquipmentTypesResponse, error)
	...
	// Resolve equipment type from alert labels
	ResolveEquipmentType(context.Context, *ResolveEquipmentTypeRequest) (*ResolveEquipmentTypeResponse, error)
	mustEmbedUnimplementedEquipmentTypeServiceServer()
}

// UnimplementedEquipmentTypeServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedEquipmentTypeServiceServer struct{}

func (UnimplementedEquipmentTypeServiceServer) CreateEquipmentType(context.Context, *CreateEquipmentTypeRequest) (*EquipmentType, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateEquipmentType not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) GetEquipmentType(context.Context, *GetEquipmentTypeRequest) (*EquipmentType, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEquipmentType not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) GetEquipmentTypeByName(context.Context, *GetEquipmentTypeByNameRequest) (*EquipmentType, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEquipmentTypeByName not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) ListEquipmentTypes(context.Context, *ListEquipmentTypesRequest) (*ListEquipmentTypesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEquipmentTypes not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) UpdateEquipmentType(context.Context, *UpdateEquipmentTypeRequest) (*EquipmentType, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateEquipmentType not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) DeleteEquipmentType(context.Context, *DeleteEquipmentTypeRequest) (*DeleteEquipmentTypeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteEquipmentType not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) ResolveEquipmentType(context.Context, *ResolveEquipmentTypeRequest) (*ResolveEquipmentTypeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveEquipmentType not implemented")
}
func (UnimplementedEquipmentTypeServiceServer) mustEmbedUnimplementedEquipmentTypeServiceServer() {}
func (UnimplementedEquipmentTypeServiceServer) testEmbeddedByValue()                              {}

// UnsafeEquipmentTypeServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to EquipmentTypeServiceServer will
// result in compilation errors.
type UnsafeEquipmentTypeServiceServer interface {
	mustEmbedUnimplementedEquipmentTypeServiceServer()
}

func RegisterEquipmentTypeServiceServer(s grpc.ServiceRegistrar, srv EquipmentTypeServiceServer) {
	// If the following call panics, it indicates UnimplementedEquipmentTypeServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&EquipmentTypeService_ServiceDesc, srv)
}

func _EquipmentTypeService_CreateEquipmentType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateEquipmentTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).CreateEquipmentType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_CreateEquipmentType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).CreateEquipmentType(ctx, req.(*CreateEquipmentTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_GetEquipmentType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEquipmentTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).GetEquipmentType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_GetEquipmentType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).GetEquipmentType(ctx, req.(*GetEquipmentTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_GetEquipmentTypeByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEquipmentTypeByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).GetEquipmentTypeByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_GetEquipmentTypeByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).GetEquipmentTypeByName(ctx, req.(*GetEquipmentTypeByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_ListEquipmentTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEquipmentTypesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).ListEquipmentTypes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_ListEquipmentTypes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).ListEquipmentTypes(ctx, req.(*ListEquipmentTypesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_UpdateEquipmentType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateEquipmentTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).UpdateEquipmentType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_UpdateEquipmentType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).UpdateEquipmentType(ctx, req.(*UpdateEquipmentTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_DeleteEquipmentType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteEquipmentTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).DeleteEquipmentType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_DeleteEquipmentType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).DeleteEquipmentType(ctx, req.(*DeleteEquipmentTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EquipmentTypeService_ResolveEquipmentType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveEquipmentTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EquipmentTypeServiceServer).ResolveEquipmentType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentTypeService_ResolveEquipmentType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EquipmentTypeServiceServer).ResolveEquipmentType(ctx, req.(*ResolveEquipmentTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// EquipmentTypeService_ServiceDesc is the grpc.ServiceDesc for EquipmentTypeService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var EquipmentTypeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "alerting.routing.v1.EquipmentTypeService",
	HandlerType: (*EquipmentTypeServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateEquipmentType",
			Handler:    _EquipmentTypeService_CreateEquipmentType_Handler,
		},
		{
			MethodName: "GetEquipmentType",
			Handler:    _EquipmentTypeService_GetEquipmentType_Handler,
		},
		{
			MethodName: "GetEquipmentTypeByName",
			Handler:    _EquipmentTypeService_GetEquipmentTypeByName_Handler,
		},
		{
			MethodName: "ListEquipmentTypes",
			Handler:    _EquipmentTypeService_ListEquipmentTypes_Handler,
		},
		{
			MethodName: "UpdateEquipmentType",
			Handler:    _EquipmentTypeService_UpdateEquipmentType_Handler,
		},
		{
			MethodName: "DeleteEquipmentType",
			Handler:    _EquipmentTypeService_DeleteEquipmentType_Handler,
		},
		{
			MethodName: "ResolveEquipmentType",
			Handler:    _EquipmentTypeService_ResolveEquipmentType_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "alerting/routing/v1/routing_service.proto",
